...
public abstract class CSHelper {
    ...
    public abstract ArrayList<String> getOPEEvalList(ArrayList<BigInteger> encryptedCoeff, List<Integer> mySet, BigInteger n);

    public abstract ArrayList<String> getCardinalityEvalList(List<BigInteger> encryptedCoeff, List<Integer> mySet, BigInteger n);
