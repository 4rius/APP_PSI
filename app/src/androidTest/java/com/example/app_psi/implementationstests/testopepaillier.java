...
public class testopepaillier {
    ...
    public void testope() {
        ...
        for (Integer element : bobSet) {
            ...
            switch (element) {
                case 2: assertEquals(paillier.Decryption(Epbj), BigInteger.valueOf(0));
                case 3: assertEquals(paillier.Decryption(Epbj), BigInteger.valueOf(0));
                case 8: assertEquals(paillier.Decryption(Epbj), BigInteger.valueOf(0));
                case 1: assertEquals(paillier.Decryption(Epbj), BigInteger.valueOf(0));
                    break;
                default:
                    continue;
            }
